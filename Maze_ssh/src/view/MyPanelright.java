...
public class MyPanelright extends JPanel implements Runnable {
    ...
    public void paint(Graphics g) {
        super.paint(g);
        ImageIcon icon1 = new ImageIcon("src/data/others/结束语1.png");
        ImageIcon icon2 = new ImageIcon("src/data/others/结束语3.png");
        ImageIcon icon3 = new ImageIcon("src/data/others/遮罩.png");
        ImageIcon icon4 = new ImageIcon("src/data/others/op_bg.jpg");
        ImageIcon icon5 = new ImageIcon("src/data/others/序幕语2.png");
